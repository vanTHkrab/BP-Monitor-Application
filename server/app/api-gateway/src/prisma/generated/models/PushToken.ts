...
export type PushTokenCountAggregateOutputType = {
  ...
  pendingReceiptId: number
  pendingReceiptAt: number
  createdAt: number
  updatedAt: number
  _all: number
}
...
export type PushTokenMinAggregateInputType = {
  ...
  pendingReceiptId?: true
  pendingReceiptAt?: true
  createdAt?: true
  updatedAt?: true
}
...
export type PushTokenWhereInput = {
  ...
  deviceLabel?: Prisma.StringNullableFilter<"PushToken"> | string | null
  platform?: Prisma.StringNullableFilter<"PushToken"> | string | null
  lastRegisteredAt?: Prisma.DateTimeFilter<"PushToken"> | Date | string
  pendingReceiptId?: Prisma.StringNullableFilter<"PushToken"> | string | null
  pendingReceiptAt?: Prisma.DateTimeNullableFilter<"PushToken"> | Date | string | null
...
export type PushTokenOrderByWithRelationInput = {
  ...
  pendingReceiptId?: Prisma.SortOrderInput | Prisma.SortOrder
  pendingReceiptAt?: Prisma.SortOrderInput | Prisma.SortOrder
...
export type PushTokenScalarWhereWithAggregatesInput = {
  ...
  deviceLabel?: Prisma.StringNullableWithAggregatesFilter<"PushToken"> | string | null
  platform?: Prisma.StringNullableWithAggregatesFilter<"PushToken"> | string | null
  lastRegisteredAt?: Prisma.DateTimeWithAggregatesFilter<"PushToken"> | Date | string
  pendingReceiptId?: Prisma.StringNullableWithAggregatesFilter<"PushToken"> | string | null
  pendingReceiptAt?: Prisma.DateTimeNullableWithAggregatesFilter<"PushToken"> | Date | string | null
...
export type PushTokenCreateInput = {
  ...
  pendingReceiptId?: string | null
  pendingReceiptAt?: Date | string | null
...
export type PushTokenUpdateInput = {
  ...
  pendingReceiptId?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
  pendingReceiptAt?: Prisma.NullableDateTimeFieldUpdateOperationsInput | Date | string | null
...
export type PushTokenCountOrderByAggregateInput = {
  ...
  lastRegisteredAt?: Prisma.SortOrder
  pendingReceiptId?: Prisma.SortOrder
  pendingReceiptAt?: Prisma.SortOrder
  createdAt?: Prisma.SortOrder
  updatedAt?: Prisma.SortOrder
}
...
export type PushTokenSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
  ...
  pendingReceiptId?: boolean
  pendingReceiptAt?: boolean
  createdAt?: boolean
  updatedAt?: boolean
...
export type PushTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "token" | "userId" | "deviceLabel" | "platform" | "lastRegisteredAt" | "pendingReceiptId" | "pendingReceiptAt" | "createdAt" | "updatedAt", ExtArgs["result"]["pushToken"]>
...
export type $PushTokenPayload<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  scalars: runtime.Types.Extensions.GetPayloadResult<{
    id: string
    /**
     * The `ExponentPushToken[…]` string. Validated with `Expo.isExpoPushToken`
     * before it is ever written — an unparseable token is a guaranteed wasted
     * send on every future critical reading.
     */
    token: string
    userId: string
    /**
     * What the user sees in a device list, e.g. "Pixel 8". Nullable: the
     * client may not be able to name the device, and refusing the
     * registration over a cosmetic field would cost the alert itself.
     */
    deviceLabel: string | null
    /**
     * 'ios' | 'android'. A string rather than an enum for the same reason
     * `ProfileChangeLog.field` is: it is displayed, never dispatched on, and a
     * new value should not need a migration.
     */
    platform: string | null
    /**
     * Refreshed on every registration call. The client registers on each
     * launch, so this doubles as "when was this installation last alive" —
     * the only signal available for a token that is still valid but belongs
     * to a device nobody uses.
     */
    lastRegisteredAt: Date
    /**
     * The receipt id for the most recent push accepted by Expo, and when it
     * was accepted.
     * 
     * Expo's ticket only says "queued"; the *delivery* outcome — including a
     * `DeviceNotRegistered` that FCM/APNs only reports after the fact — comes
     * back from a receipt fetched later. Parking the id here rather than in a
     * dedicated table keeps the pruning sweep to one join-free query, and one
     * row per token is sufficient: if a newer push overwrote the id, the older
     * receipt can no longer tell us anything the newer one will not.
     */
    pendingReceiptId: string | null
    pendingReceiptAt: Date | null
    createdAt: Date
...
export interface PushTokenFieldRefs {
  ...
  readonly deviceLabel: Prisma.FieldRef<"PushToken", 'String'>
  readonly platform: Prisma.FieldRef<"PushToken", 'String'>
  readonly lastRegisteredAt: Prisma.FieldRef<"PushToken", 'DateTime'>
  readonly pendingReceiptId: Prisma.FieldRef<"PushToken", 'String'>
  readonly pendingReceiptAt: Prisma.FieldRef<"PushToken", 'DateTime'>
