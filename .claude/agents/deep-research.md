...
- /.agents/skills/*/SKILL.md  (vendored third-party skills, not this project's agents — those are `.claude/agents/*.md`)
...
| Modify any agent definition under `.claude/agents/` | `agent-create` (for creation) / the agent's owner (for updates) |
