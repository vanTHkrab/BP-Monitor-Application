...
export default function DiagramPage() {
    return (
        <DiagramShell
            slug="activity"
            chart={CHART}
            caption="Four lanes, one journey."
        >
            <h2>Worth knowing</h2>
            <ul>
                <li>Only the patient lane is allowed to feel synchronous. Lanes 3 and 4 are explicitly allowed to take seconds.</li>
                <li>The online/offline fork is not a fallback but a peer: both branches produce the same outcome shape.</li>
                <li>ai-service holds no S3 credentials and no database connection. It is handed a presigned URL and answers with numbers.</li>
            </ul>
        </DiagramShell>
    );
}
