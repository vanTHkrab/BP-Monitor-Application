...
| [google-sign-in-setup.md](./google-sign-in-setup.md) | Same shape again, for Google sign-in — four credential values, one project rule, and why every mistake produces the same `DEVELOPER_ERROR` |
